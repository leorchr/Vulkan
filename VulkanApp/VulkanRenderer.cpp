...
void VulkanRenderer::createGraphicsPipeline()
{
	...
	auto vertexShaderCode = readShaderFile("Ressources/Shaders/shader1.vert.spv");
	auto fragmentShaderCode = readShaderFile("Ressources/Shaders/shader1.frag.spv");
...
vk::DeviceSize* imageSize)
{
	...
	std::string path = "Ressources/Textures/" + filename;
